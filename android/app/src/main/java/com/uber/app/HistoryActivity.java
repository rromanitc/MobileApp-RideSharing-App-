...
import com.uber.app.historyRecyclerView.HistoryAdapter;
import com.uber.app.historyRecyclerView.HistoryObject;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    private void payoutRequest() {
        ...
        final Request request = new Request.Builder()
                ...
                .url("https://us-central1-uber-d42b3.cloudfunctions.net/payout")
                .post(body)
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response)
                ...
                if (response.isSuccessful())
                    ...
                    Snackbar.make(findViewById(R.id.layout), "Error: couldn't complete ", Snackbar.LENGTH_LONG).show();
